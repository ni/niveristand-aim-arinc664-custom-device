...
niveristand-aim-afdx-custom-device follows a pull-request model for development.  If you wish to
...
Build specifications are provided for building the custom device template. The build process should automatically copy the output files to the directory required by VeriStand.
